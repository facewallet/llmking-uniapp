...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    g: $options.nodes && $options.nodes.length
  }, $options.nodes && $options.nodes.length ? {
    h: $options.nodes,
    i: common_vendor.o((...args) => $options.trOnclick && $options.trOnclick(...args))
  } : {}, {
    j: $props.showCursor ? 1 : ""
  }) : {
    k: common_vendor.t($options.msgContent)
  }, {
    l: $props.isLastMsg && $props.msg.isAi
  }, $props.isLastMsg && $props.msg.isAi ? {
    m: common_vendor.o($options.changeAnswer),
    n: common_vendor.p({
      title: "换一个答案",
      color: "#ccc",
      type: "reload",
    ...
    p: common_vendor.o(($event) => $data.showMoreMenu = !$data.showMoreMenu),
    q: $data.showMoreMenu
  }, $data.showMoreMenu ? {
    r: common_vendor.o((...args) => $options.copy && $options.copy(...args)),
    s: common_vendor.o($options.removeMsg),
    t: common_vendor.p({
      type: "trash",
      size: "20",
      color: "#ccc"
    }),
    v: common_vendor.o(($event) => $data.showMoreMenu = false)
  } : {}, {
    w: $props.msg.isAi ? 1 : "",
    x: !$props.msg.isAi ? 1 : ""
  }) : {});
